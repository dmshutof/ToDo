    ...
    return (
            ...
            <div className="todo__sidebar">
...

                {
                    todosArr.length!==0 ? (
                    todosArr.length ? (
                        <Link to="/" className="todo__sidebar-item first" >
                            ...
                            todosArr.map( (todo) => {
                                ...
                                return (
                                        <SidebarItem
                                            key={todo.id}
                                            id={todo.taskKey}
                                            title={todo.taskItem.title}
                                            colorClass={todo.taskItem.colorClass}
                                        />
                ...
                <AddButton
                    name={'Добавить папку'}
                    formItem={false}/* true - добавление задачи, false - добавление папки */
                />
